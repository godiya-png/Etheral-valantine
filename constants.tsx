...
export const ClipboardIcon = ({ className }: { className?: string }) => (
  <svg 
    ...
    className={className}
  >
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.666 3.888A2.25 2.25 0 0 0 13.5 2.25h-3c-1.03 0-1.9.693-2.166 1.638m7.332 0c.055.194.084.4.084.612v0c0 .634-.312 1.22-.836 1.57l-.85.568a2.25 2.25 0 0 1-2.492 0l-.85-.568A2.25 2.25 0 0 0 9 4.5V4.5c0-.212.03-.418.084-.612m7.332 0c.346.102.637.311.83.585a2.25 2.25 0 0 1 .438 1.327V18.75a2.25 2.25 0 0 1-2.25 2.25H6.75a2.25 2.25 0 0 1-2.25-2.25V5.8c0-.495.16-0.96.44-1.33a2.25 2.25 0 0 1 .83-0.58" />
  </svg>
);
